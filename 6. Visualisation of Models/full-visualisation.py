...
model = tf.keras.models.load_model("../Model_32-16Neuron_5-13Kernel_0.956accuracy")
...
# untransformed_img = load_img("../../DataGenerationUpdated/UserDataTraining/UserSignal/PilotData17_Result=121.png", target_size=(128, 128))
# img = img_to_array(untransformed_img)
# img = np.expand_dims(img, axis=0);
