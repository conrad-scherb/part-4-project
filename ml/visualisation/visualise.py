...
model = tf.keras.models.load_model("./ml/Model_2Neuron_15Kernel_0.92accuracy")
...
img2 = load_img("./DataGenerationUpdated/UserDataTraining/UserNoSignal/PilotData2_Result=110.png", target_size=(128, 128))
